...
RESOLVED_PUSH_MICROSERVICE_URL=$(sanitize_val "${PUSH_MICROSERVICE_URL:-${VITE_PUSH_MICROSERVICE_URL:-/push}}")
...
window.__HUMID1_CONFIG__ = {
  ...
  PUSH_MICROSERVICE_URL: "${RESOLVED_PUSH_MICROSERVICE_URL}"
};
...
window.__ENV__ = {
  ...
  VITE_PUSH_MICROSERVICE_URL: "${RESOLVED_PUSH_MICROSERVICE_URL}"
};
EOF
