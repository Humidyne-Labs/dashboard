...
window.__HUMID1_CONFIG__ = {
  ...
  DASHBOARD_VERSION: "${DASHBOARD_VERSION:-${VITE_DASHBOARD_VERSION:-1.0.6-beta}}",
  DASHBOARD_REVISION: "${DASHBOARD_REVISION:-${VITE_DASHBOARD_REVISION:-dev}}"
};
...
window.__ENV__ = {
  ...
  VITE_DASHBOARD_VERSION: "${DASHBOARD_VERSION:-${VITE_DASHBOARD_VERSION:-1.0.6-beta}}",
  VITE_DASHBOARD_REVISION: "${DASHBOARD_REVISION:-${VITE_DASHBOARD_REVISION:-dev}}"
};
EOF
