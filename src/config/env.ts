...
export const APP_CONFIG: Humid1Config = {
  ...
  version: getEnv('VITE_DASHBOARD_VERSION', import.meta.env.VITE_DASHBOARD_VERSION || '1.0.6-beta'),
  revision: getEnv('VITE_DASHBOARD_REVISION', import.meta.env.VITE_DASHBOARD_REVISION || 'dev'),
};
